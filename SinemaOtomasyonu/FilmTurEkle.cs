        ...
        private void button_kaydet_Click(object sender, EventArgs e)
        {
            if (txt_tur.Text != "")
            {
                try
                {
                    ...
                    SqlCommand kaydet = new SqlCommand("INSERT INTO FilmTurleri (tur)VALUES('" + txt_tur.Text + "')", Form_Vizyon.baglanti);
                    kaydet.ExecuteNonQuery();
                    Form_Vizyon.baglantikapa();
                    MessageBox.Show("Film türü eklendi!", "Başarılı", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    temizle();
                }
