        ...
        private void button_kaydet_Click(object sender, EventArgs e)
        {
            if (masktxt_tarih.Text != "  .  ." && masktxt_tel.Text != "(   )    -   " && txt_ad.Text != "")
            {
                try
                {
                    ...
                    SqlCommand kaydet = new SqlCommand("INSERT INTO Personeller (ad,dogum,telefon)VALUES('" + txt_ad.Text + "','" + masktxt_tarih.Text + "','" + masktxt_tel.Text + "')", Form_Vizyon.baglanti);
                    kaydet.ExecuteNonQuery();
                    kaydet = new SqlCommand("INSERT INTO PersonelGecmisleri (baslik,aciklama,saat,tarih)VALUES('Personel ekleme','" + txt_ad.Text + " adlı personel eklendi.','" + DateTime.Now.ToShortTimeString() + "','" + DateTime.Now.ToShortDateString() + "')", Form_Vizyon.baglanti);
                    kaydet.ExecuteNonQuery();
